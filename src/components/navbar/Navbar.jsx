          ...
          <div className="">
            <div className="flex h-16 items-center">
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokestrokewidth="1.5" stroke="currentColor" className="w-6 h-6">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Ajay Chauhan</h1>
                  </div>
                </Link>
              </div>
